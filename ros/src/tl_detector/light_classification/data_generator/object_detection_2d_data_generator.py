                ...
                if transformations:
                    ...
                    for transform in transformations:
                        ...
                        if not (self.labels is None):
                            ...
                            if ('inverse_transform' in returns) and ((isinstance(transform, types.FunctionType) and 'return_inverter' in inspect.getargspec(transform).args) or (callable(transform) and 'return_inverter' in inspect.getargspec(transform.__call__).args)):
                            ...
                            if ('inverse_transform' in returns) ((isinstance(transform, types.FunctionType) and 'return_inverter' in inspect.getargspec(transform).args) or (callable(transform) and 'return_inverter' in inspect.getargspec(transform.__call__).args)):
